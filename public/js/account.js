...
var folderShow = function folderShow(list) {
  ReactDOM.render(_react2['default'].createElement(_folder2['default'], { list: list }), document.getElementById("container"));
...
},{"./folder":9,"react":7}],9:[function(require,module,exports){
'use strict';
...
var Folder = (function (_React$Component) {
  ...
  _createClass(Folder, [{
    ...
    value: function putShow() {
      ...
      var list = [];
      var d = undefined;
      db.collection("urlset").doc(this.props.id).collection("urlputs").get().then(function (querysnapShots) {
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;
        ...
        ;
        history.pushState('', '', "?id=" + _this.props.id);
...
function urlputShow(list) {
  ReactDOM.render(_react2['default'].createElement(_url2['default'], { list: list }), document.getElementById("container"));
}
...
var folderShow = function folderShow(list) {
  ReactDOM.render(_react2['default'].createElement(Folders, { list: list }), document.getElementById("container"));
...
},{"./url":10,"react":7}],10:[function(require,module,exports){
"use strict";
